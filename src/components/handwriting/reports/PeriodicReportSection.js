...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 15, fontWeight: '700', fontFamily: 'Nunito_700Bold', color: TEXT_1 },
  periodLabel: { marginTop: 10, fontSize: 12, fontWeight: '600', fontFamily: 'Nunito_600SemiBold', color: TEXT_2 },
  ...
  subCardTitle: { fontSize: 12.5, fontWeight: '700', fontFamily: 'Nunito_700Bold', color: TEXT_1, marginBottom: 6 },
  kvRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 2 },
  kvLabel: { fontSize: 11.5, color: TEXT_2, flex: 1 },
  kvValue: { fontSize: 11.5, fontWeight: '700', fontFamily: 'Nunito_700Bold', color: TEXT_1 },
  subHeading: { fontSize: 13, fontWeight: '700', fontFamily: 'Nunito_700Bold', color: TEXT_1, marginTop: 12, marginBottom: 4 },
  ...
  exportBtnText: { color: '#FFFFFF', fontSize: 13, fontWeight: '700', fontFamily: 'Nunito_700Bold' },
});
