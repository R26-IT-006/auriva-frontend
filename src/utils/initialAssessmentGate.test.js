...
const welcome = stripComments(read('../screens/teacher/handwriting/WelcomeScreen.js'));
...
describe('the other two consumers of hasData are untouched', () => {
  it('the teacher report still gates its section on hasData', () => {
    const teacher = stripComments(read('../screens/teacher/handwriting/reports/TeacherReportScreen.js'));
