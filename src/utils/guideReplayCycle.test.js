...
const LETTER = '../screens/handwriting/LetterWritingScreen.js';
const UPPER  = '../screens/handwriting/uppercase/UppercaseWritingScreen.js';
const WORD   = '../screens/handwriting/words/WordWritingScreen.js';
...
describe('§14 — nothing outside the animation controller changed', () => {
  ...
  it('the other looped demos were left alone', () => {
    ...
    expect(readCode('../screens/handwriting/PreWritingActivityScreen.js'))
      .toMatch(/Animated\.loop\(\s*Animated\.timing\(animValue, \{ toValue: 1/);
    expect(readCode('../screens/handwriting/ShapeAssessmentScreen.js'))
