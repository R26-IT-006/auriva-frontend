...
const screen      = read('../screens/teacher/handwriting/WritingCheckScreen.js');
...
describe('routing', () => {
  ...
  it('the screen needs only the params its callers actually pass', () => {
    ...
    expect(read('../screens/teacher/handwriting/LetterHomeScreen.js'))
    ...
    expect(read('../screens/teacher/handwriting/reports/TeacherReportScreen.js'))
