...
import { CATEGORIES } from '../data/letterCategories';
...
const demoScreen    = read('../screens/teacher/handwriting/HandwritingDemoScreen.js');
const letterScreen  = read('../screens/teacher/handwriting/LetterWritingScreen.js');
const upperScreen   = read('../screens/teacher/handwriting/uppercase/UppercaseWritingScreen.js');
const welcomeScreen = read('../screens/teacher/handwriting/StudentWelcomeScreen.js');
const wordWriting   = read('../screens/teacher/handwriting/words/WordWritingScreen.js');
const wordActivity  = read('../screens/teacher/handwriting/words/WordActivityScreen.js');
const navigator     = read('../navigation/HandwritingNavigator.js');
const shapeScreen   = read('../screens/teacher/handwriting/ShapeAssessmentScreen.js');
