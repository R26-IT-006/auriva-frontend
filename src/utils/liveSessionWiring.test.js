...
const LEARNING_SCREENS = [
  { path: '../screens/teacher/handwriting/LetterWritingScreen.js',               activityType: 'LOWERCASE_LETTER' },
  { path: '../screens/teacher/handwriting/uppercase/UppercaseWritingScreen.js',  activityType: 'UPPERCASE_LETTER' },
  { path: '../screens/teacher/handwriting/words/WordWritingScreen.js',           activityType: 'WORD_WRITING' },
  { path: '../screens/teacher/handwriting/PreWritingActivityScreen.js',          activityType: 'PREWRITING' },
  { path: '../screens/teacher/handwriting/words/WordActivityScreen.js',          activityType: 'WORD_ACTIVITY' },
];
...
describe('Attempt/support/case updates are bundled into one meaningful-event push', () => {
  it('LetterWritingScreen and UppercaseWritingScreen push current_item + case_type + attempt_number + support_level together', () => {
    for (const p of ['../screens/teacher/handwriting/LetterWritingScreen.js', '../screens/teacher/handwriting/uppercase/UppercaseWritingScreen.js']) {
      const source = read(p);
