...
const WORD_SCREEN  = '../screens/teacher/handwriting/words/WordWritingScreen.js';
const DEMO         = '../screens/teacher/handwriting/HandwritingDemoScreen.js';
...
describe('pre-writing shows ONE primary instruction', () => {
  ...
  it('but the data keeps both fields — nothing was deleted from the catalogue', () => {
    const cat = read('../data/preWritingActivities.js');
...
describe('SENTINEL — feedback, flow, logic, geometry and layout unchanged', () => {
  it('feedback messages are untouched', () => {
    const feedback = readCode('../screens/teacher/handwriting/AttemptAvatarFeedback.js');
  ...
  it('reference paths and canvas geometry are untouched', () => {
    ...
    for (const rel of ['../data/wordPaths.js', '../constants/letterCanvasLayout.js']) {
