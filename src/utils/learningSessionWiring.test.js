...
const LEARNING_SCREENS = [
  { name: 'LetterWritingScreen',    path: '../screens/handwriting/LetterWritingScreen.js' },
  { name: 'UppercaseWritingScreen', path: '../screens/handwriting/uppercase/UppercaseWritingScreen.js' },
  { name: 'WordWritingScreen',      path: '../screens/handwriting/words/WordWritingScreen.js' },
  { name: 'PreWritingActivityScreen', path: '../screens/handwriting/PreWritingActivityScreen.js' },
  { name: 'WordActivityScreen',     path: '../screens/handwriting/words/WordActivityScreen.js' },
];
