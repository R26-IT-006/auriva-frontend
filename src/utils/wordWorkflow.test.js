...
test('screen orchestration blocks navigation when authoritative saves fail', () => {
  const writing = fs.readFileSync(path.resolve(__dirname, '../screens/teacher/handwriting/words/WordWritingScreen.js'), 'utf8');
  const practice = fs.readFileSync(path.resolve(__dirname, '../screens/teacher/handwriting/words/WordActivityScreen.js'), 'utf8');
