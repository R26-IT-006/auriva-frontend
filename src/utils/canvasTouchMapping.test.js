...
describe('every canvas uses the shared mapper', () => {
  ...
  it("the border each canvas declares matches its own canvasCard borderWidth", () => {
    const declared = {
      '../screens/teacher/handwriting/LetterWritingScreen.js': 1.5,
      '../screens/teacher/handwriting/uppercase/UppercaseWritingScreen.js': 1.5,
      '../screens/teacher/handwriting/ShapeAssessmentScreen.js': 2,
      '../screens/teacher/handwriting/PreWritingActivityScreen.js': 2,
      '../screens/teacher/handwriting/words/WordWritingScreen.js': 1.5,
...
describe('SENTINEL — geometry, storage and scoring untouched', () => {
  ...
  it('reference path constants are untouched', () => {
    for (const rel of ['../data/wordPaths.js', '../constants/activityPreviewLetterPaths.js']) {
      const code = readCode(rel);
  ...
  it('the stored point schema is unchanged', () => {
    expect(readCode('../screens/teacher/handwriting/LetterWritingScreen.js'))
...
describe('pointer-guide interpolation needs two keyframes', () => {
  const POINTER_SCREENS = [
    ['../screens/teacher/handwriting/PreWritingActivityScreen.js', 'pathPoints'],
    ['../screens/teacher/handwriting/ShapeAssessmentScreen.js',    'pathPoints'],
  ];
