...
const SELECT = '../screens/handwriting/words/WordLetterSelectScreen.js';
...
describe('C — filtering happens when a sequence is BUILT, never mid-flow', () => {
  ...
  it('no screen in the A-E flow re-filters its own list', () => {
    for (const rel of ['../screens/handwriting/words/WordWritingScreen.js',
                       '../screens/handwriting/words/WordActivityScreen.js',
                       '../screens/handwriting/words/WordProgressScreen.js']) {
