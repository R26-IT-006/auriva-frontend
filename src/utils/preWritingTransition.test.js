...
import { getLetterPrimitiveGroup, PRIMITIVE_GROUPS } from '../constants/preWritingActivities';
...
describe('SENTINEL — sequencing, scoring and geometry untouched', () => {
  it('the category definitions and the primitive map are unchanged', () => {
    ...
    const pre = readCode('../constants/preWritingActivities.js');
  ...
  it('reference paths and pre-writing geometry are untouched', () => {
    const pre = read('../constants/preWritingActivities.js');
