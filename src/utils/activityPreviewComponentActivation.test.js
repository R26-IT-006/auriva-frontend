...
describe('35. no extra useFocusEffect added', () => {
  it('the total useFocusEffect count is unchanged from Feature 9 Step 5 (exactly 3: main report + Feature 8 recommendations + Feature 9 history — Feature 10 adds none)', () => {
    const source = readScreen();
