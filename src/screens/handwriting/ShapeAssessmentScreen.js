...
const SHAPES = [
  ...
  },
  {
    ...
    instruction: 'Follow the zigzag line left to right',
    pageLabel: 'Assessment 5 of 6',
  },
  {
    id: 'curve_wave',
    label: 'Draw the wave',
    instruction: 'Follow the wavy curved line',
...
export default function ShapeAssessmentScreen({ route, navigation }) {
  ...
  // Restart animation on shape change
  useEffect(() => {
      ...
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.topArea}>
            ...
            <View style={[styles.instructionCard, { borderLeftColor: theme.cardOutline }]}>
              <Text style={styles.instructionText}>{currentShape.instruction}</Text>
            </View>
          </View>
