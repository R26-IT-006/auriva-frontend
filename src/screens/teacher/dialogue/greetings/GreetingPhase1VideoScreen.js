...
// Narration audio (Sinhala+English combined recordings, 2026-08-30) — hello
// and goodbye each share one audio across all 3 of their videos; every other
...
export default function GreetingPhase1VideoScreen({ route, navigation }) {
  ...
  // Narration audio (only hello/goodbye have one — see the constants above)
  // — kept in sync with the video: (re)starts whenever the video (re)starts,
